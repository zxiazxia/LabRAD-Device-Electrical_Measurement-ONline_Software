...
path = sys.path[0] + r"\Four Terminal Gate Sweep Probe Station\FourTerminalGateSweepProbeStationSetting"
Ui_Setting, QtBaseClass = uic.loadUiType(path + r"\FourTerminalGateSweepProbeStationSettingWindow.ui")
